...
public class CallTheWatchPresenter extends BasePresenter implements TimePopupWindow.TimeLiCallBack,LifecyclePresenterInterface, DialogView.DialogConfirm,OnRecyclerItemClickListener {
    private ActivityCallTheWatchBinding binding;
